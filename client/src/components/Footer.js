        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-white/60 mb-4 max-w-md">
              ...
              Your ultimate destination for movie information and entertainment.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/search" className="text-white/60 hover:text-white transition-colors duration-200">
                  Browse Movies
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/register" className="text-white/60 hover:text-white transition-colors duration-200">
                  Sign Up
                </Link>
              </li>
            </ul>
